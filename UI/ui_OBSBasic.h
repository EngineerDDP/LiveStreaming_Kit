...
public:
    ...
    void setupUi(QMainWindow *OBSBasic)
    {
        ...
        gridLayout_2->addLayout(sourcesVLayout, 1, 0, 1, 1);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/res/images/add.png"), QSize(), QIcon::Normal, QIcon::Off);
        transitionAdd->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/res/images/list_remove.png"), QSize(), QIcon::Normal, QIcon::Off);
        transitionRemove->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/res/images/configuration21_16.png"), QSize(), QIcon::Normal, QIcon::Off);
